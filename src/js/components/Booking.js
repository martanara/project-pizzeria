...
class Booking {
  ...
  getData(){
    ...
    thisBooking.datePicker.minDate = new Date();
    thisBooking.datePicker.maxDate = utils.addDays(thisBooking.datePicker.minDate, settings.datePicker.maxDaysInFuture);
